...
const resultData: ResultList[] = [
  {
    ...
    resultIntroduction: '모든 잎사귀에 정교한 계획이 숨어있다.',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "튼튼하고 오래 사는 관음죽은 신뢰를 중요하게 생각하는 '<span>정밀한 그린 엔지니어</span>'의 가치관과 잘 어울려요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '식물의 손길로 마음을 치유하는 초록의 힐러',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "부드러운 잎사귀가 매력적인 관엽베고니아는 배려심 깊은 '<span>식물 감성 치유사</span>'의 성격과 잘 어울려요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '식물의 사색 속에서 인생의 답을 찾다',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "독특한 꽃이 매력적인 네오레겔리아는 내적인 성장을 추구하는 '<span>내면을 가꾸는 식물 철학자</span>'에게 영감을 줘요.",
      },
    ],
  },
  {
    ...
    mbti: 'INTJ',
    resultTitle: '🌳 초록 설계자 🌳',
    resultIntroduction: '자연을 기반으로 완벽한 초록 도시를 설계한다',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "다채로운 색감이 매력적인 크로톤은 분석적인 '<span>초록 설계자</span>'에게 지적 호기심을 자극해요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '식물의 미지의 세계를 끝없이 탐험하는 개척자',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "튼튼하고 생명력이 강한 군자란은 독립적인 '<span>실험적인 그린 탐험가</span>'에게 힘을 주는 존재에요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '자연 속에서 예술적인 영감을 발견하는 순간의 기록자',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "싱그러운 잎사귀가 매력적인 아이비는 자유로운 영혼을 가진 '<span>자연의 순간을 포착하는 감성 아티스트</span>'에게 편안함을 선사해요.",
      },
    ],
  },
  {
    ...
    mbti: 'INFP',
    resultTitle: '🎥 그린스토리텔러 🎥',
    resultIntroduction: '초록의 세상 속 이야기를 생생하게 전하는 내레이터',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "사랑스러운 꽃이 매력적인 옥살리스(사랑초)는 섬세한 '<span>그린스토리텔러</span>'에게 행복을 가져다줘요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '식물의 비밀을 파헤치며 문제를 해결하는 탐정',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "독특한 무늬가 매력적인 칼라데아 마코야나는 창의적인 '<span>문제 해결하는 식물 탐정</span>'에게 영감을 줘요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '가장 눈부신 초록의 순간을 놓치지 않는 관찰자',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "화려한 색감이 매력적인 드라세나 '트리컬러 레인보우'는 모험심 강한 '<span>식물계의 스포트라이트</span>'에게 도전 정신을 북돋아요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '초록의 활기로 가득 찬 파티를 연출하는 주인공',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "다채로운 색감이 매력적인 칼랑코에는 활기찬 '<span>초록 파티 메이커</span>'에게 에너지를 충전시켜요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '빈틈없이 식물의 성장 과정을 지켜보는 철저한 관리자',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "쭉쭉 뻗어 자라는 아레카야자는 목표 지향적인 '<span>효율적인 식물 감독관</span>'의 성격과 잘 어울려요.",
      },
    ],
  },
  {
    ...
    mbti: 'ESFJ',
    resultTitle: '👑 그린 팀 리더 👑',
    resultIntroduction: '초록 군단을 이끌며 식물 세상을 지휘하는 리더',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "푸르른 잎사귀가 매력적인 백량금은 따뜻한 마음씨를 가진 '<span>그린 팀 리더</span>'에게 안정감을 제공해요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '식물 경영의 청사진을 그리는 전략가',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "튼튼하고 생명력이 강한 유카는 리더십이 강한 '<span>전략적인 플랜트 CEO</span>'에게 힘을 주는 존재에요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '새로운 식물 세계를 혁신적으로 개척하는 선구자',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "화려한 무늬가 매력적인 피토니아 핑크스타는 모험심 강한 '<span>혁신적인 식물 개척자</span>'에게 도전 정신을 북돋아요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '초록 꿈을 현실로 만들어가는 상상력의 주인공',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "다채로운 무늬가 매력적인 수박필레아는 창의적인 '<span>창의적인 그린 드리머</span>'에게 영감을 줘요.",
      },
    ],
  },
  {
    ...
    resultIntroduction: '식물과 지구를 돌보는 헌신적인 리더십',
    resultText:
    ...
    recommendedPlants: [
      ...
      },
      {
        ...
        description: "사랑스러운 꽃이 매력적인 엘라티올 베고니아는 배려심 깊은 '<span>그린 케어 리더</span>'에게 행복을 가져다줘요.",
      },
    ],
  },
];
