  ...
  return (
    <form className={styles.filter_wrapper} onSubmit={handleSubmit(submitHandler)}>
      <div className={styles.filter_group}>
        ...
        <div className={styles.question_section}>
          <p className={styles.question_title}>식물의 꽃색을 선택해주세요.</p>
          <div className={styles.label_wrapper}>
            {[
        ...
        <div className={styles.question_section}>
          <p className={styles.question_title}>식물의 열매색을 선택해주세요.</p>
          <div className={styles.label_wrapper}>
            {[
        ...
        <div className={styles.question_section}>
          <p className={styles.question_title}>식물의 잎무늬를 선택해주세요.</p>
          <div className={styles.label_wrapper}>
            {[
        ...
        <div className={styles.question_section}>
          ...
          <div className={styles.label_wrapper}>
            {[
              ...
              <label key={type.waterCycleCode} htmlFor={type.waterCycleCode} className={`${styles.custom_checkbox} ${styles.lg}`}>
                <Controller
                  name="waterCycleCode"
                  control={control}
                  render={({ field }) => (
                    <input type="checkbox" id={type.waterCycleCode} value={type.waterCycleCode} checked={field.value === type.waterCycleCode} onChange={(e) => field.onChange(e.target.value)} />
                  )}
                />
      ...
      <div className={styles.btn_wrapper}>
        <Button type="button" bgColor="line" onClick={onClose}>
          취소
        </Button>
